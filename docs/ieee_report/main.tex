...
\begin{itemize}[noitemsep]
  ...
  \item \textbf{Tests:} \texttt{tests/} --- 76 checks over every module,
        plus a mutation suite reintroducing each defect reported here and
        asserting the tests catch it (6/6).
